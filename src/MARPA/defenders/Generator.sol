...
/**
@notice a generator defense asset
@dev 
- user is rewarded a generator by a lootbox
- id in contract must be equal to the creator_id
- need generator to power other defences
- powers 3 buildings around 3 blocks
 */

contract Generator is MERC1155, IDefender {
    ...
    function place(
        ...
        burn(owner, id, 1);
        board.placeGenerator(_x, _y, false, owner, address(this), health, id);
    }
